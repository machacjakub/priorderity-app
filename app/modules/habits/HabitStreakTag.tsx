...
export const HabitStreakTag = ( { label, streak, streakWithoutToday }: IProps ) => {
	...
	return <div className='text-foreground bg-white dark:bg-background bg-gradient-to-tr from-white dark:from-background to-white dark:to-gray-400/30 py-3 px-5 border-l-2 border-b-2 border-l-blue-600 border-b-blue-600 dark:border-l-blue-300 dark:border-b-blue-300 rounded-xl flex justify-between gap-3'>
