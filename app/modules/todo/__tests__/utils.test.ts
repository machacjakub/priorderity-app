import { countConsecutiveDatesFromToday, getTimeUnitsSince } from "@/app/modules/todo/utils";
...
const arr5 = [ new Date(), new Date( '2024/03/18 16:04' ), new Date( '2024/03/17 16:04' ), new Date( '2024/03/16 16:04' ), new Date( '2024/03/15 16:04' ) ];
const arr0 = [ new Date( '2024/03/18 16:04' ), new Date( '2024/03/17 16:04' ), new Date( '2024/03/16 16:04' ), new Date( '2024/03/15 16:04' ) ];
const arr2 = [ new Date(), new Date( '2024/03/18 21:04' ), new Date( '2024/03/15 16:04' ), new Date( '2024/03/14 16:04' ), new Date( '2024/03/13 16:04' ) ];
const arr3 = [ new Date(), new Date( '2024/03/18 15:09' ), new Date( '2024/03/17 20:04' ), new Date( '2024/03/15 16:04' ), new Date( '2024/03/13 16:04' ) ];
const arr1 = [ new Date() ];
